...
<body class="p-2 md:p-4 mode-app">
        ...
        <header class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4 bg-slate-900 p-3 rounded-xl shadow-lg">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <div class="flex bg-slate-800/50 p-1 rounded-lg border border-slate-700/50 ml-auto md:ml-2">
                    ...
                    <button onclick="setViewMode('web')" id="modeWebBtn" class="flex items-center gap-1.5 px-2 py-1 rounded text-[9px] font-bold uppercase transition-all text-slate-500 hover:text-slate-300">
                        Web
                    </button>
                </div>
            </div>
                    ...
                    <div id="fileDimsDisplay" class="hidden">
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="grid grid-cols-2 gap-2 mt-2">
                                ...
                                <div class="bg-slate-50 p-2 rounded border border-slate-100 text-center">
                                    <span class="block text-[8px] font-bold text-slate-400 uppercase">Vetor Largura</span>
    ...
    <script>
        const dom = {
            ...
            modeAppBtn: document.getElementById('modeAppBtn'),
            modeWebBtn: document.getElementById('modeWebBtn')
        };
        ...
        function setViewMode(mode) {
            if (mode === 'web') {
                ...
                dom.modeAppBtn.classList.remove('bg-slate-700', 'text-white');
                ...
                dom.modeWebBtn.classList.add('text-slate-500');
            }
            updatePreview();
        }
        ...
        function generateLayout() {
            ...
            dom.resultInfo.innerText = `${countPlaced} VETORES PROCESSADOS`;
        }
